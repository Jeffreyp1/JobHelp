...
- JSON list: `job-digest/scripts/greenhouse-tokens.json` (sorted alphabetically, one token per line)
- This report: `job-digest/scripts/greenhouse-tokens-report.md`
